...
class MambaMOS(PointModule):
    def __init__(
        ...
        in_channels=5,
        gather_num=8,
        order=("z", "z_trans",'hilbert','hilbert-trans'),
        stride=(2, 2, 2, 2),
    ...
    def forward(self, data_dict):
        ...
        # indices = sparse_tensor.indices  # [batch, z, y, x] 格式的索引
        ...
        # point_features = torch.zeros(spatial_shape, dtype=features.dtype)
        # for idx, feature in zip(indices, features):
        #     point_features[idx[0], idx[1], idx[2], idx[3]] = feature
